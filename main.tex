...
\paragraph{Physical mechanisms behind the mechanical properties of blood}
...
\paragraph{Thixotropic response}\textit{
...
\paragraph{Time independent  viscosity models}
...
\paragraph{Time dependent viscosity  models}
...
four non-Newtonian characteristics - a a) shear thinning viscosity, b) a general viscoelastic response to transient flow deformations and a c) non-zero yieldstress with d) associated
thixotropy
    \item Starting point for the flow analysis is in a macroscopic viewpoint the continuity equation and momentum equations
